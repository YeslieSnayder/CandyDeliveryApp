...
1. Clone repo: `https://github.com/YeslieSnayder/CandyDeliveryApp.git`
2. Open the directory: `cd CandyDeliveryApp/`
3. Install requirements: `pip install -r requirements.txt`
4. Launch the app: `python ...` or if you install PyPy, then `pypy3 ...`
